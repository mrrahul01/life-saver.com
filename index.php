...
<div class="main" style="height: 220px;">
	<div class="content">		
			<h4 style="color:red; font-weight: bold;">Blood bank:</h4>
			<p style="color:black;">We welcome you to in our WebSite. If you are a donor , We appreciate you <a href="registration.php">signing up</a> online as a Donor. If you need blood we are happy to serve you. This blood donor list is hosted by <a href="index.php">www.lifesaver.com</a> on behalf of "Life Saver Blood Bank"
...
We request donors to update contact details regularly.</p>
	...
	<div class="sidebar" >
			<h2 style="color:red; font-weight: bold;">Latest News</h2>
			<div class="blog_posts">

    <marquee direction="up" scrolldelay="0" style="height: 150px;"><table >
<tr><td>
                         <div class="blog_desc">
...
<p>The blood donation camp organised by HDFC Bank on December 6, 2013 involving 61,902 participants has found a place in Guinness Book of Records as the largest such drive on a single day</p></span>
                         ...
                         <br />
	<span style="font-weight:bold"><b>World Blood Donor Day: Poor health reduces women blood donors </b>
<p>While the overall number of blood donors in world has grown over the years, women constitute only a tiny 10 percent share owing to health problems like pernicious anaemia and low haemoglobin levels or being underweight</p></span>
					  </div>
                        </td></tr>

...
<div class="cont_main">
	<div class="content">
		<img src="Images/about.png" height="70px"  />
			<h2><span class="bold" style="color: red;">News Letter from the Founders</span></h2>
			<p style="text-align: justify;font-weight: 900;"><img src="Images/123.jpg" height="200px" style="margin-bottom:40px" /></a>'Life Saver Blood Bank' is the first product resulted out of the community welfare initiative called 'People Project' from uSiS Technologies. Universally, 'Blood' is recognized as the most precious element that sustains life. It saves innumerable lives across the world in a variety of conditions. Once in every 2- seconds, someone, somewhere is desperately in need of blood. More than 29 million units of blood components are transfused every year. The need for blood is great - on any given day, approximately 39,000 units of Red Blood Cells are needed. Each year, we could meet only up to 1% (approx) of our nation’s demand for blood transfusion.</p>
			<p class="top" style="text-align: justify;font-weight: 900;">Despite the increase in the number of donors, blood remains in short supply during emergencies, mainly attributed to the lack of information and accessibility. We positively believe this tool can overcome most of these challenges by effectively connecting the blood donors with the blood recipients.
We remind every visitor that we have the empowerment to save lives and let’s do that – right now, right here. If you are eligible for blood donation, please register yourself as a blood donor now!</p>
			<p class="top" style="text-align: justify;font-weight: 900;">We also take this opportunity to thank our whole team for all your ideas, commitment and hard-ship in making this dream a reality. We would also like to thank our friends and well-wishers for all your support and encouragement throughout this project. It is now reasonably safe to say that together we have made this society a slightly better and safer place to live.</p>
		<p class="top" style="color: red;font-weight: 900;">Thank you and Happy Blood donating!</p>
		<br>	
        <p class="top" style="color: blue"> Abu Sithik</p>
<p style="color: blue">Heman Duraiswamy</p>
<p style="color: blue">Surendar Ram</p>
        <p class="top" style="color: red">Promoters,</p>
<p style="color: blue">Blood Bank India.</p>
 <br>      
	</div>
	<div class="sidebar">
			<div>  
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved | Design by <a href="https://www.facebook.com/rahul.khan.2095"> Md Ruhul Khan </a> |</p>
		</div>
	<div class="clear"></div>
</div>
</div>

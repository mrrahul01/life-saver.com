...
<div class="main_cont">
     <div class="main">
        <div class="content">
          ...
          <h2 style="font-size: 50px; color: red">Campus</h2>
            <br /><br />
...
$s="select * from camp,state,city where camp.state=state.state_id and camp.city=city.city_id";
    ...
    <table cellpadding="0" cellspacing="0" class="tableborder" width="520" style="border:none">
    <tr><td style="font-size:20px; font-weight:bold; width:100%; text-shadow:1px 1px 6px browm; padding-left:50px; padding-top:10px; padding-bottom:10px; color:#925959"><p style="font-size: 25px;color: #101079;"><?php echo $data[1]; ?></p></td></tr>
      <tr><td align="center"> 
